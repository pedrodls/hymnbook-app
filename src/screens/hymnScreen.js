...
import { Container, Header, List, ListItem, Item, Input,Left, Body, Text } from 'native-base';
import { ActivityIndicator, FlatList, View } from 'react-native';

import _ from 'lodash'

export default class Hymnscreen extends Component {
  ...
  requestApiPhotos(){
    ...
    const apiURL = "http://192.168.100.17:8800/api/v1/hymns"
